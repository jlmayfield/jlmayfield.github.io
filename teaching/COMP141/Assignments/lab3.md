---
layout: page
title: COMP141 - Lab 3 - In the Cloud
permalink: /teaching/COMP141/Assignments/03_in_the_cloud/
---

# Lab 3 - In the Cloud

We'll be using [Google Cloud Platform (GCP)](https://cloud.google.com/) to complete most of our labs from here on out.  More specifically, you will be using [Google Compute Engine](https://cloud.google.com/products/compute) to launch a virtual machine running linux.  From this machine, you can carry out your work.

GPC has some nice [free tier](https://docs.cloud.google.com/free/docs/free-cloud-features#free-tier-usage-limits) services that should cover our needs for this class. Just in case, you'll be getting $50 in credit for GPC. So, if you accidentally incur some costs, you should be covered.
